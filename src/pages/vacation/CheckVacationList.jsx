...
const VacationList = () => {
  ...
  const { data: hr, loading: loadingHr } = useSelector(
    (state) => state.hrStudyTime
  );
  ...
  return (
    <>
      ...
      >
        <Typography sx={{ color: "#fff" }}>{t("Check_List_Leaves")}</Typography>
        <Box>
          <Input
            ...
            {UserList?.data?.data.map((row, i) => (
              ...
              >
                ...
                >
                  ...
                  >
                    <Box>
                      <img style={{ margin: "0 7px" }} src={row?.avatar} />
                    </Box>
